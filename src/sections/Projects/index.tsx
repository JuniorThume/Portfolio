...
const projects = [
  ...
  }, 
  {
    ...
    link: 'https://github.com/JuniorThume/Portfolio',
...
const Projects = () => {
  ...
  return (
    <div id='projects' className='flex flex-col justify-self-center relative items-center w-2/3 my-4'>
      ...
      <div className='p-2 gap-1 overflow-y-auto max-h-[500px] w-full flex flex-col'>
        {
          projects?.map((pjt) => {
